...
<div class="row justify-content-sm-center" style="background-color: #fbf2fb">
    <div class="col-sm-5 mt-3">
        <h3 style="color: #b87bd0">Goal</h3>
            <p style="color: #b87bd0">Current studies of IMC analysis in the literature use simple statistical approaches. Here, we want to take advantage of the high-throughput nature of imaging mass cytometry data by developing a <b>machine learning</b>-based analysis pipeline.</p>
    </div>
    <div class="col-sm-7 mt-3">
        <h3 style="color: #b87bd0">Result</h3>
            <p style="color: #b87bd0">Developed a standardized machine learning-based analysis pipeline for IMC data for predicting various clinical outcomes of a cancer patient. We also introduced a novel augmentation approach that is specific to IMC data.</p>
    </div>
</div>
